 	...
 	if(isset($_POST["submit"])){
		...
		if($_POST["username"] === $textArray[0][0] && $_POST["password"] === $textArray[0][1]){
			if(isset($_POST["checked"])){
				...
				header( 'location: opdracht cookies3.php' );
			}
			$loggedIn=true;
...
<!--	<pre><?php print_r($textArray); ?></pre> -->
	...
	<?php if($loggedIn): ?>
		<h1>Dashboard</h1>
		<p>Hallo <?= $textArray[0][0] ?>, fijn dat je er weer bij bent!</p>
		<a href="opdracht cookies3.php?cookie=delete">Uitloggen</a>


	
	<?php else: ?>
	<form action="opdracht cookies3.php" method="post">
